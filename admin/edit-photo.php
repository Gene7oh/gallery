                    ...
                    <div class="col-md-4">
                        <div class="photo-info-box">
                            <div class="info-box-header">
                                <h4 id="">Info <span id="toggle" class="glyphicon glyphicon-menu-up pull-right"></span></h4>
                            </div>
                            <div class="inside">
                                <div class="box-inner">
                                    <p class="text">
                                    ...
                                    <p class="text glyphicon glyphicon-qrcode">
                                        Photo Id: <span class=" data photo_id_box"><?php echo $photo->id; ?></span>
                                    </p>
                                    <p class="text glyphicon glyphicon-file">
                                        Filename: <span class="data"><?php echo $photo->filename; ?></span>
                                    </p>
                                    <p class="text glyphicon glyphicon-open-file">
                                        File Type: <span class="data"><?php echo $photo->type; ?></span>
                                    </p>
                                    <p class="text glyphicon glyphicon-eye-open">

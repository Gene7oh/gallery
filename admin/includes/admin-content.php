        ...
        <div class="col-lg-12">
            ...
            <?php
                ...
                if (!$user_found) {
                    ...
                    $user             = new User();
                    $user->user_id    = $user_found['user_id'];
                    $user->username   = $user_found['username'];
                    $user->user_fname = $user_found['user_fname'];
                    $user->user_lname = $user_found['user_lname'];
                    echo $user->user_id . "<br>" . $user->username . "<br>" . $user->user_fname . " " . $user->user_lname;
                }
                echo "</pre>";

            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="row col-md-6 user-image-box">
                        <label
                            for="image"><small><?php echo "UserID: $user->id  <br> Image Title:  $user->user_image <br> Member Since: " ?></small></label><br>
                        <div class="form-group">
                            <a href="#" data-toggle="modal" data-target="#photo-modal">
                                <img class="image-shadow img-responsive"
                                     src="<?php echo $user->placeholderOrImage(); ?>"
                                     alt="<?php echo $user->user_image; ?>">
                            </a>
                        </div>
                    </div>
                            ...
                            <div class="form-group">
                                <label for="first-name">First Name
                                    <input type="text" name="first-name" class="form-control"
                                           value="<?php echo $user->user_fname; ?>"></label>
                            </div>
                            <div class="form-group">
                                <label for="last-name">Last name
                                    <input type="text" name="last-name" class="form-control"
                                           value="<?php echo $user->user_lname; ?>"></label>
                            </div>
                            <div class="form-group">
                                <label for="password">Current Password
                                    <input type="password" class="form-control" name="password"
                                           value="<?php echo $user->user_password; ?>"></label>
                            </div>
                            <div class="info-box-update">
                                <?php /*if (isset($_POST['delete-user'])) {
                                    redirect("includes/delete-user.php?delete-id=$user->id");
                                } */ ?>
                                <a id="find_user_id" href="includes/delete-user.php?delete-id=<?php echo $user->id; ?>"
                                   class="btn btn-danger btn-lg delete-link">Delete</a>
